...
Claude Code Plugin — 一鍵初始化 Ubuntu 24.04 Server，打造完整的現代化開發��境。

## 使用方式

本 repo 是一個 Claude Code Plugin，安裝後只要��訴 Claude Code：

> 幫我初始化 IP 為 x.x.x.x 的 Ubuntu 主機，帳號密碼是 user/pass

Claude Code 會自動建立 SSH key、設定免密登���，然後執行完整安裝。
...
### Shell 環境
- **zsh** + **oh-my-zsh**
- 自訂主題 **myclean**（顯示��機名、使用者、目錄、git 狀態）
